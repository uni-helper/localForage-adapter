...
export async function getItem(key, callback) {
  enqueueOperation(async () => {
    ...
    try {
      ...
      executeCallback(value, callback);
    } catch (error) {
...
export async function key(index, callback) {
  enqueueOperation(async () => {
    ...
    try {
      ...
      const retrievedKey = result.length > 0 ? result[0].key : null;
      executeCallback(retrievedKey, callback);
    } catch (error) {
...
export async function length(callback) {
  enqueueOperation(async () => {
    ...
    try {
      ...
      executeCallback(count, callback);
    } catch (error) {
...
export async function iterate(callback) {
  enqueueOperation(async () => {
    ...
    try {
      ...
      executeCallback(returnValue !== undefined ? returnValue : result, callback);
    } catch (error) {
